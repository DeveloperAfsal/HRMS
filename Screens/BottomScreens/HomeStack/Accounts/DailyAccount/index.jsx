...
const DailyAcc = ({ navigation }) => {
    ...
    const fetchBalanceCash = async () => {
        try {
            const apiUrl = 'https://ocean21.in/api/public/api/balance_cash';
    ...
    const fetchData = async () => {
        setLoadData(true)
        try {
            const apiUrl = 'https://ocean21.in/api/public/api/view_dailyaccounts';
            const response = await axios.get(apiUrl, {
                headers: {
                    Authorization: `Bearer ${data.token}`
                }
    ...
    const HandleSubmit = async () => {
        ...
        try {
            ...
            const apiUrl = 'https://ocean21.in/api/public/api/add_dailyaccounts';
