...
const EditCompany = ({ route, navigation }) => {
    ...
    const HandleSubmit = async () => {
        ...
        try {
            ...
            const apiUrl = 'https://ocean21.in/api/public/api/update_company_information';
    ...
    const GetData = async () => {
        ...
        try {
            const apiUrl = `https://ocean21.in/api/public/api/editview_company_information/${SpecId}`;
            const response = await axios.get(apiUrl, {
                headers: {
                    Authorization: `Bearer ${data.token}`
                }
                ...
                <View style={styles.Inputcontainer}>
                    ...
                    {showStatus && (
                        ...
                        <View style={styles.dropdown}>
                            ...
                            <TouchableOpacity onPress={() => selectStatus("Male")} style={styles.dropdownOption}>
                                <Text style={styles.dropdownOptionText}>Male</Text>
                            </TouchableOpacity>

                            <TouchableOpacity onPress={() => selectStatus("Female")} style={styles.dropdownOption}>
                                <Text style={styles.dropdownOptionText}>Female</Text>
                            </TouchableOpacity>

                            <TouchableOpacity onPress={() => selectStatus("Others")} style={styles.dropdownOption}>
