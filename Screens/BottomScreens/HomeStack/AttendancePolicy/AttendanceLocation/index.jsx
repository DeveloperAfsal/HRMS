...
const AttendanceLocation = () => {
    ...
    const HandleSubmit = async () => {
        ...
        try {
            ...
            const apiUrl = 'https://ocean21.in/api/public/api/attendancelocationinsert';
    ...
    const fetchData = async () => {
        setLoadData(true)
        try {
            const apiUrl = 'https://ocean21.in/api/public/api/view_attendancelocation';
    ...
    const confirmDelete = async () => {
        ...
        if (slotToDelete) {
            ...
            try {
                ...
                const apiUrl = `https://ocean21.in/api/public/api/delete_attendancelocation`;
                const response = await axios.post(apiUrl, {
                    id: slotToDelete,
    ...
    const handleEditSubmit = async () => {
        ...
        try {
            ...
            const apiUrl = 'https://ocean21.in/api/public/api/update_attendancelocation';
                                    ...
                                    {Datalist.length === 0 ? (
                                        ...
                                        Datalist.map((slot, index) => (
                                            <View style={styles.listcontent} key={index}>
                                                ...
                                                <Text style={styles.listcontentShift}>{slot.request_location}</Text>
