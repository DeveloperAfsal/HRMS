...
import { Text, TextInput, View, TouchableOpacity, ScrollView, Image, Platform, Alert, ActivityIndicator } from "react-native";
...
const BasicDetails = ({ onEmpDetails, selectedImage, setSelectedImage, employee, setEmployee }) => {
                ...
                <View style={styles.container}>
                    {showInitialImage ? (
                        employee.profile_img ? <View style={styles.imageContainer}>
                            ...
                            <Image source={{ uri: `https://ocean21.in/api/storage/app/${employee.profile_img}` }} style={styles.image} />
                        </View> : ""
                    ) : (
