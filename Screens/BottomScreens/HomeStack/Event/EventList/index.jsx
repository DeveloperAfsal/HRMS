...
const Eventlist = ({ navigation }) => {
    ...
    const fetchData = async () => {
        setLoadData(true)
        try {
            const apiUrl = 'https://ocean21.in/api/public/api/view_event_list';
    ...
    const confirmDelete = async () => {
        ...
        if (slotToDelete) {
            ...
            try {
                ...
                const apiUrl = `https://ocean21.in/api/public/api/delete_event`;
    ...
    const HandleConfirm = async () => {
        ...
        try {
            ...
            const apiUrl = `https://ocean21.in/api/public/api/approval_event`;
                            ...
                            {paginatedData.length === 0 ? (
                                ...
                                paginatedData.map((item, index) => (
                                    <View key={index} style={[styles.row, styles.listBody]}>
                                        ...
                                        <Text style={[styles.cell, styles.Status]}>{item.e_agenda}</Text>
