...
const HRHalfDayRequest = () => {
    ...
    const fetchTableData = async () => {
        setLoading(true);
        const apiUrl = 'https://officeinteriorschennai.com/api/public/api/halfday-request-lsit';
        const requestData = {
            halfdayrequestlistempid: data.userempid,
            halfdayrequestlistroleid: data.userrole
        };
    ...
    const handleAction = async (item, value) => {
        try {
            ...
            const response = await fetch('https://officeinteriorschennai.com/api/public/api/approval_halfday_request', {
                method: 'POST',
                body: formData,
                headers: {
                    Authorization: `Bearer ${data.token}`
    ...
    const renderTableRows = () => {
        return visibleData.map((item, index) => (
            <Row key={index}
                ...
                widthArr={[100, 100, 100, 150, 150, 150, 250, 200]}
            />
        ));
    };
    ...
    return (
        <ScrollView refreshControl={<RefreshControl refreshing={refreshing} onRefresh={HandleRefresh} />}>
            <View style={styles.container}>
                ...
                <View>
                    <Text style={styles.heading}>Half Day Request List :</Text>
                </View>
...
export default HRHalfDayRequest