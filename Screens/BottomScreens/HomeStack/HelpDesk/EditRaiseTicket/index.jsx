...
const EditRaiseTicket = ({ route, navigation }) => {
    ...
    useEffect(() => {
        const issType = async () => {
            ...
            try {
                const apiUrl = 'https://ocean21.in/api/public/api/issue_type_list';
                const response = await axios.get(apiUrl, {
                    headers: {
                        Authorization: `Bearer ${data.token}`
                    }
    ...
    useEffect(() => {
        ...
        const EditRaisetick = async () => {
            ...
            try {
                const apiUrl = `https://ocean21.in/api/public/api/editview_raiselist/${SpecId.id}`;
                const response = await axios.get(apiUrl, {
                    headers: {
                        Authorization: `Bearer ${data.token}`
                    }
    ...
    const AddTick = async () => {
        ...
        try {
            ...
            const apiUrl = 'https://ocean21.in/api/public/api/update_raiseticket';
