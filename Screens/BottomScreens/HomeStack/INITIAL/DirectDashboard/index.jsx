    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.post(
                'https://officeinteriorschennai.com/api/public/api/viewadmindashboardpresentemplis',
                { emp_status: value },
                {
                    headers: {
    ...
    const renderTableRows = () => {
        return visibleData.map((item, index) => (
            <Row key={index}
                ...
                widthArr={[100, 100, 120, 120, 100, 100, 100, 100]}
            />
        ));
    };
                        ...
                        <ScrollView horizontal>
                            <View style={styles.tableContainer}>
                                <Table borderStyle={styles.tableBorder}>
                                    <Row
                                        data={['S.No', 'Name', 'Check In \n(Date & Time)', 'Check Out \n(Date & Time)', 'Present/Absent', 'Late', 'Permission', 'On duty', 'Total Hours']}
