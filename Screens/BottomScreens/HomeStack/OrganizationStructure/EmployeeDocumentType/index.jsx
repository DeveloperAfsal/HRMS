...
const DocumentType = () => {
    ...
    const fetchData = async () => {
        setLoadData(true)
        try {
            const apiUrl = 'https://ocean21.in/api/public/api/view_empdoctype';
    ...
    const confirmDelete = async () => {
        ...
        if (slotToDelete) {
            ...
            try {
                ...
                const apiUrl = `https://ocean21.in/api/public/api/delete_empdoctype`;
                const response = await axios.post(apiUrl, {
                    id: slotToDelete,
    ...
    const handleEditSubmit = async () => {
        ...
        try {
            ...
            const apiUrl = 'https://ocean21.in/api/public/api/update_empdoctype';
