...
const EditAssignEmpSalary = ({ route, navigation }) => {
    ...
    useEffect(() => {
        ...
        const Edit = async () => {
            ...
            try {
                const apiUrl = `https://ocean21.in/api/public/api/show_define_emp_salary/${SpecId.id}`;
    ...
    const AddAss = async () => {
        ...
        try {
            ...
            const apiUrl = 'https://ocean21.in/api/public/api/update_define_emp_salarylist';
