...
const styles = StyleSheet.create({
    ...
    ViewDetails1: { width: '75%', height: 38, borderWidth: 1, backgroundColor: '#0A62F1', borderRadius: 5, alignItems: 'center', justifyContent: 'center' },
    DetailsText: { color: '#0A62F1', fontWeight: '700', fontSize: 15 },
    DetailsText1: { color: '#fff', fontWeight: '700', fontSize: 15 }
})
