...
const AddLead = ({ navigation }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const apiUrl = 'https://ocean21.in/api/public/api/getautogenerateLeadId';
                const response = await axios.get(apiUrl, {
                    headers: {
                        Authorization: `Bearer ${data.token}`
                    }
    ...
    const HandleSubmit = async () => {
        ...
        try {
            ...
            const apiUrl = 'https://ocean21.in/api/public/api/sales_addlead';
