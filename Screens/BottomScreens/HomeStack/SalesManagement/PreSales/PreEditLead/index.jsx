...
const PreEditList = ({ navigation, route }) => {
    ...
    const HandleSubmit = async () => {
        ...
        try {
            ...
            formData.append('user_whatapp', whatsAppNumber);
            ...
            formData.append('user_leaddate', formattedStartDate ? formattedStartDate : startDate);
            ...
            formData.append('call_backon', formattedStartDate1 ? formattedStartDate1 : startDate1);
            formData.append('comment', comment);
            formData.append('prooffiletype', value || null);

            formData.append('assign_sale_dep_id', selectedDepartmentsId || null);
            formData.append('assign_sale_emp_id', selectedMemberId || null);
            formData.append('role_id', data.userrole);
            formData.append('status_date', formattedStartDate2 ? formattedStartDate2 : startDate2);
            formData.append('lead_status', selectededStatus || null);
            formData.append('comments', statusComment || null);
            ...
            const response = await fetch('https://ocean21.in/api/public/api/editpresale_leadlist', {
                method: 'POST',
                headers: {
