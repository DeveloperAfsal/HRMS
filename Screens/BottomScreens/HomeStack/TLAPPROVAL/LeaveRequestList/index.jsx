...
const TLLeaveRequest = () => {
    ...
    const fetchTableData = async () => {
        ...
        setLoading(true);
        const apiUrl = 'https://officeinteriorschennai.com/api/public/api/tl_leave_list_approval';

        const requestData = {
            leavelistapprovalempid: data.userempid,
            leavelistapprovalroleid: data.userrole,
        };
    ...
    const handleAction = async (item, value) => {
        ...
        try {
            ...
            const response = await fetch('https://officeinteriorschennai.com/api/public/api/approval_leave_tl', {
                method: 'POST',
                body: formData,
                headers: {
                    Authorization: `Bearer ${data.token}`
