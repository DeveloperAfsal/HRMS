...
const TLPermissionRequest = () => {
    ...
    const fetchTableData = async () => {
        ...
        setLoading(true);
        const apiUrl = 'https://officeinteriorschennai.com/api/public/api/tl_permission_list_approval';

        const requestData = {
            permisstionapprovallistempid: data.userempid,
            permisstionapprovallistroleid: data.userrole,
        };
    ...
    const handleAction = async (item, value) => {
        ...
        try {
            ...
            const response = await fetch('https://officeinteriorschennai.com/api/public/api/approval_permission_tl', {
                method: 'POST',
                body: formData,
                headers: {
                    Authorization: `Bearer ${data.token}`
