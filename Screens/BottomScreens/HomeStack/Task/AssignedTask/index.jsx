...
const AssignedTask = () => {
    ...
    const fetchData = async () => {
        setLoadData(true)
        try {
            const apiUrl = 'https://ocean21.in/api/public/api/view_assigntask_list';
    ...
    const confirmDelete = async () => {
        ...
        if (slotToDelete) {
            ...
            try {
                ...
                const apiUrl = `https://ocean21.in/api/public/api/delete_task`;
    ...
    const handleEditSubmit = async () => {
        ...
        try {
            const apiUrl = `https://ocean21.in/api/public/api/filter_tasklist`;
    ...
    useEffect(() => {
        const apiUrl = `https://ocean21.in/api/public/api/supervisor_department_list/${data.userrole}`;
